...
public abstract class Product  {
    ...
    public Product(String id, String code, String name, long purchasePrice, long salePrice, int remaining, Date addDate, Date updateDate, Employee updater, String position) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.purchasePrice = purchasePrice;
    ...
    public void display(){
        ...
        System.out.println("Vi tri dat san pham:  " + position);
    }
